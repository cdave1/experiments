...
class TwitterOAuthClient(oauth.OAuthClient):
    api_root_url = 'https://api.xero.com' #for testing 'http://term.ie'
    api_root_port = "80"

    #set api urls
    def request_token_url(self):
        return self.api_root_url + '/oauth/RequestToken'
    def authorize_url(self):
        return self.api_root_url + '/oauth/Authorize'
    def access_token_url(self):
        return self.api_root_url + '/oauth/AccessToken'
...
if __name__ == '__main__':
    consumer_key = 'MTY4MDJKZGMWZGE2NDVIOTHMMDZKYT'
    consumer_secret = 'NTK4MDJJNZHIM2Q5NGY4YJK5ZDHIMJ'
    ...
    response_token = raw_input('What is the oauth_token from Xero: ')
